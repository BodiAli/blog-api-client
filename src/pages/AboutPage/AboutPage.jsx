  ...
  return (
    <main className={styles.main}>
      ...
      <p className={styles.paragraph}>
        ...
        taking control of your online presence. Whether you&apos;re a seasoned writer or just getting started,
        The Log Blog makes it effortless to craft beautiful posts, engage with a vibrant community through
        ...
        like-minded bloggers. Join us at The Log Blog, where your story isn&apos;t just written, it&apos;s
        celebrated.
      </p>
    </main>
  );
